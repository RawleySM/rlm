...
1. Defining the base RLM_SYSTEM_PROMPT (formerly from rlm/utils/prompts.py)
...
# =============================================================================
# Legacy RLM Base Prompts (Copied from rlm/utils/prompts.py)
# =============================================================================
...
def build_rlm_system_prompt(
    ...
    Args:
        ...
        context_metadata: Metadata object containing context info (RLMContextMetadata or QueryMetadata).

    Returns:
        List of message dictionaries
    """
    # Handle both legacy QueryMetadata and ADK RLMContextMetadata
    if hasattr(context_metadata, "context_lengths"):
        context_lengths = context_metadata.context_lengths
        context_total_length = context_metadata.context_total_length
        context_type = context_metadata.context_type
    elif hasattr(context_metadata, "chunk_sizes"):
        context_lengths = context_metadata.chunk_sizes
        context_total_length = context_metadata.total_size_chars
        context_type = context_metadata.context_type
    else:
    ...
    if len(context_lengths) > 100:
        ...
        context_lengths_str = str(context_lengths[:100]) + "... [" + str(others) + " others]"
    else:
