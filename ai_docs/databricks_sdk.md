...
```
#### Default databricks environment

DATABRICKS_HOST=https://adb-6983841757863745.5.azuredatabricks.net
DATABRICKS_PROFILE=rstanhope

# Cluster ID for Python REPL execution
DATABRICKS_CLUSTER_ID=1115-120035-jyzgoasz

# SQL Warehouse ID for SQL query execution
DATABRICKS_SQL_WAREHOUSE_ID=57f6389fdcdefbc0

# =============================================================================
# Unity Catalog Configuration (Optional)
# =============================================================================

# Default catalog for operations
DEFAULT_CATALOG=silo_dev_rs

# Masterdata catalog name
MASTERDATA_CATALOG=masterdata_prod

# Hospital chain catalogs (comma-separated)
HOSPITAL_CHAIN_CATALOGS=silo_nvhs, silo_chs, silo_mayo
